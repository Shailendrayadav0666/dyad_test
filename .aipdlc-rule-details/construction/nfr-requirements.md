...
## Prerequisites
- Functional Design must be complete (artifacts in `aipdlc-docs/construction/design/functional-design/`); if it was skipped, use the intake brief + requirements + stories as inputs instead
...
- Read functional design artifacts from `aipdlc-docs/construction/design/functional-design/` (if it exists; else use the intake brief + requirements + stories)
...
### Step 4: Store Plan
- Save as `aipdlc-docs/construction/plans/nfr-requirements-plan.md`
...
- Create `aipdlc-docs/construction/design/nfr-requirements/nfr-requirements.md`
- Create `aipdlc-docs/construction/design/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `aipdlc-docs/construction/design/nfr-requirements/`
...
- Mark NFR Requirements stage complete in aipdlc-state.md
