...
- Intake brief available at `aipdlc-docs/inception/requirements/epic-brief.md` (from the provided Epic, or from the user's requirements document / natural language)
...
- Read the intake brief from `aipdlc-docs/inception/requirements/epic-brief.md` (if present) — it defines WHAT to build
- Read requirements from `aipdlc-docs/inception/requirements/requirements.md`
- Read stories from `aipdlc-docs/inception/user-stories/stories.md` and the `## Story Tracker` in `aipdlc-state.md`
- Read `aipdlc-docs/inception/application-design/` artifacts (if Application Design ran) for component structure and boundaries
...
### Step 4: Store Plan
- Save as `aipdlc-docs/construction/plans/functional-design-plan.md`
...
- Create `aipdlc-docs/construction/design/functional-design/business-logic-model.md`
- Create `aipdlc-docs/construction/design/functional-design/business-rules.md`
- Create `aipdlc-docs/construction/design/functional-design/domain-entities.md`
- If the system includes frontend/UI: Create `aipdlc-docs/construction/design/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `aipdlc-docs/construction/design/functional-design/`
...
- Mark Functional Design stage complete in aipdlc-state.md
